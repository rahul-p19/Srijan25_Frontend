  ...
  return (
    <div className='h-[90vh] w-screen max-w-full grid grid-cols-7 sm:grid-cols-5 relative overflow-x-clip'>
      ...
      <div className='col-span-5 sm:col-span-3 grid grid-cols-2 grid-rows-10 sm:grid-rows-6 border-l border-r border-l-white border-r-white'>
        <div className='sm:border-r border-b border-white flex items-end sm:row-span-1'>
          <img src='/inverted-commas.svg' className='p-1 sm:p-4 border-white border-t border-r h-1/3 sm:h-3/5' />
        </div>
        <div className='border-white border-b sm:row-span-1'></div>
        ...
        <div className='row-span-[0] col-span-[0] sm:row-span-4 sm:col-span-1 border-r-white sm:border-r flex p-6'>
        </div>
        <div className='row-span-1 col-span-2 sm:row-span-4 sm:col-span-1 flex items-end justify-center sm:justify-end'>
          <a className='p-3 border-white border sm:border-r-transparent sm:border-b-transparent text-lg sm:text-2xl z-[101] text-background bg-white from-white to-light-pink' href='/register'>Register Now</a>
        </div>
      </div>
      <div></div>
      <div className='absolute hidden sm:block z-[90] bottom-[25%] sm:bottom-0 left-[10%] h-[10%] sm:h-[22.5%] bg-background border border-white sm:border-b-transparent'>
        <img src='/fetsu-presents-srijan-glitch.svg' className='h-full' />
      </div>
      <div className='absolute p-3 z-[90] bottom-[47%] sm:bottom-[20%] right-[3%] sm:right-[12%] bg-background border border-white'>
