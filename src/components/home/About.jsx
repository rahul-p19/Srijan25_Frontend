...
function About() {
  return (
    <div className='min-h-screen border-white border-t grid grid-cols-1 sm:grid-cols-5'>
      <div className='relative h-[20vh] sm:h-screen border-white border-b sm:border-b-transparent'>
        ...
        <div className='absolute sm:hidden left-[50%] -translate-x-[50%] h-full w-5/7 border-white border-l border-r'></div>
      ...
      <div className='col-span-3 border-white sm:border-l sm:border-r grid row-span-5'>
        ...
        <div className='sm:hidden relative h-[20vh] border-white border-t sm:border-t-transparent'>
          ...
          <div className='absolute left-[50%] -translate-x-[50%] h-full w-5/7 border-white border-l border-r'></div>
        </div>
        <div className='grid grid-cols-2 sm:border-white border-t sm:border-b'>
