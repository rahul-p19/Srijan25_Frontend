...
function Gallery() {
  ...
  return (
    <div className='w-full relative border-white border-t grid grid-cols-1 grid-rows-4 sm:grid-rows-1 sm:grid-cols-5 h-[80vh] sm:h-screen overflow-x-hidden'>
      <div className='absolute left-[50%] -translate-x-[50%] sm:hidden w-5/7 border-white border-r border-l h-full'></div>
      <div className='relative sm:bg-background z-[100] h-full border-r -mr-[1px] row-span-1 border-white border-b sm:border-b-transparent'>
      ...
      <div className='relative sm:col-span-3 border-white sm:border-l sm:border-r grid grid-cols-2 row-span-3'>
